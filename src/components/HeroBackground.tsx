...
function Particles() {
    ...
    return (
        <instancedMesh ref={mesh} args={[undefined, undefined, count]}>
            ...
            <meshPhongMaterial color="#2E62A6" emissive="#BBBF3F" emissiveIntensity={0.5} />
        </instancedMesh>
    );
}
    ...
    return (
        <div className="absolute inset-0 -z-10 h-full w-full bg-[#0f172a]">
            <Canvas camera={{ position: [0, 0, 50], fov: 75 }}>
                ...
                <pointLight position={[10, 10, 10]} color="#BBBF3F" intensity={1} />
                <pointLight position={[-10, -10, -10]} color="#2E62A6" intensity={1} />
                <Particles />
            </Canvas>
